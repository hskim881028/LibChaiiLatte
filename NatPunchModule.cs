...
namespace LibChaiiLatte {
    ...
    public class EventBasedNatPunchListener : INatPunchListener {
        public delegate void
            OnNatIntroductionRequest(IPEndPoint localEndPoint, IPEndPoint remoteEndPoint, string token);
        ...
        void INatPunchListener.OnNatIntroductionRequest(IPEndPoint localEndPoint,
        ...
        void INatPunchListener.OnNatIntroductionSuccess(IPEndPoint targetEndPoint, NatAddressType type, string token) {
            NatIntroductionSuccess?.Invoke(targetEndPoint, type, token);
        }
    }
    ...
    public sealed class NatPunchModule {
        ...
        private void OnNatPunch(NatPunchPacket req, IPEndPoint senderEndPoint) {
            //Read info
            NetDebug.Write(NetLogLevel.Trace, "[NAT] punch received from {0} - additional info: {1}", senderEndPoint,
                           req.Token);
